...
while True:
 ...
 # --- INDIVIDUAL CELL PROCESSING PIPELINE ---
    ...
    if active_simulation_layer == 2:
        ...
        if background_voltage_peak >= 350.0 and not layer3_timer_active:
    ...
    # 1. Clear the screen with your deep charcoal void
        ...
        bg_volt_txt = FONT.render(f"BACKGROUND FACTORY RECHARGING: {background_voltage_peak:.2f}V / 350.00V", True, (100, 100, 150))
        ...
        # Elements are free to split indefinitely, bound strictly by localized nutrient limits.
            if _current_element_charge >= 100.0:
